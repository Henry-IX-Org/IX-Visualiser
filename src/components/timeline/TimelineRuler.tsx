...
export const TimelineRuler: React.FC<TimelineRulerProps> = ({
  ...
  return (
    <div
      ...
      className="relative h-14 bg-neutral-950 border-b border-white/10 cursor-pointer select-none font-ocra text-[9px] text-neutral-400"
    >
      ...
      {waveformMap?.dropMarkers.map((dropTime, idx) => (
        ...
        >
          <div className="bg-[#D8163F] text-white text-[8px] font-bold px-1 rounded-sm shadow-sm transform -translate-x-1/2">
            DROP
          </div>
      ...
      >
        <div className="w-3.5 h-3.5 bg-[#D8163F] rotate-45 transform -translate-y-1/2 shadow-lg shadow-[#D8163F]/80" />
        <div className="w-0.5 h-full bg-[#D8163F] shadow-lg shadow-[#D8163F]/80" />
      </div>
    </div>
  );
};
