...
export const StudioHeader: React.FC<StudioHeaderProps> = ({
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between px-3 py-1.5 bg-black/95 backdrop-blur-2xl border-b border-white/10 text-white shadow-xl font-ocra text-xs select-none">
      <input
        ref={fileInputRef}
        type="file"
        accept="audio/*"
      ...
      <div className="flex items-center gap-2.5">
        ...
        <span className="text-[11px] text-neutral-400 truncate max-w-[140px] md:max-w-xs hidden lg:inline">
          {trackName}
        </span>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-1.5 bg-neutral-950 px-2 py-0.5 rounded border border-white/10 font-mono text-[11px]">
        ...
        {sourceType === 'file' && (
          <input
            ...
            value={currentTime}
            onChange={handleSeek}
            className="w-20 md:w-32 h-1 bg-neutral-800 appearance-none cursor-pointer accent-[#D8163F] hidden sm:block"
          />
        )}
        ...
        <div className="hidden md:flex items-center gap-1 text-neutral-400">
          ...
          <input
            ...
            className="w-12 h-1 bg-neutral-800 appearance-none cursor-pointer accent-[#D8163F]"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-1.5">
        <Tooltip text="Export" position="bottom">
          <button
            ...
            className="p-1.5 rounded bg-neutral-900 hover:bg-neutral-800 text-[#D8163F] border border-[#D8163F]/40 cursor-pointer"
          >
        ...
        <Tooltip text="Inspector" position="bottom">
          <button
            ...
            className="p-1.5 rounded bg-[#D8163F] hover:bg-[#b01032] text-white cursor-pointer shadow-sm"
          >
        ...
        <Tooltip text={isFullscreen ? "Exit Fullscreen (F)" : "Fullscreen (F)"} position="bottom">
          <button
            ...
            className="p-1.5 rounded bg-neutral-900 hover:bg-neutral-800 text-neutral-400 hover:text-white border border-white/10 cursor-pointer"
          >
